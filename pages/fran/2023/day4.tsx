    ...
    <>
      ...
      <section className="pt-20 pb-12 border-b border-b-slate-500 h-[245px]">
        <h1 className="font-bold max-w-3xl mx-auto text-xl">
          Dia 4: Papa noel no estuvo muy contento con la demanda de regalos,
          vamos a tener que agregar un botón de eliminar a cada elemento para
          poder borrarlos individualmente.
        </h1>
      </section>
      <div
            ...
            <ul className="flex justify-center flex-col gap-1">
              {gifts?.map((gift) => (
                <div key={gift} className="flex justify-between">
                  <li>- {gift}</li>
                  <button className="py-1 px-2 rounded-md hover:bg-white-50">
                    Remove
                  </button>
                </div>
              ))}
