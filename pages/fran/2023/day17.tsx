    ...
    <>
      ...
      <section className="pt-20 pb-12 border-b border-b-slate-500 h-[245px]">
        <h1 className="font-bold max-w-3xl mx-auto text-xl">
          Dia 17: Nos olvidamos de agregar un campo de precio para nuestros regalos! Aseguremosnos de mostrar el precio correcto tomando en
          cuenta la cantidad de unidades del regalo.
        </h1>
      </section>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {!isTyping && (
                      <p className="ml-2 text-xs">
                        ({gift.amount} u - ${gift.price * gift.amount})
                      </p>
                    )}
                  </div>
                  {!isTyping && (
