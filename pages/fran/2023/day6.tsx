...
const Day6 = () => {
  ...
  return (
    <>
      <Head>
        <title>FRAN | Dia 6 | Adviency Challenge</title>
      ...
      <section className="pt-20 pb-12 border-b border-b-slate-500 h-[245px]">
        <h1 className="font-bold max-w-3xl mx-auto text-xl">
          Dia 6: Nuestra aplicación no se ve muy bien cuando no hay regalos,
          agreguemos un mensaje alentando a agregar regalos cuando no haya
          ninguno!
        </h1>
      </section>
      <div
