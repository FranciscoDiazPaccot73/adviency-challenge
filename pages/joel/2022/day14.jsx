import Head from 'next/head';
  ...
  const Day14 = () => (
    <>
      <Head>
        <title>JOEL | Dia 14 | Adviency Challenge</title>
      ...
      <section className="pt-20 pb-12 border-b border-b-slate-500 h-[245px]">
        <h1 className="font-bold max-w-3xl mx-auto text-xl">
          Dia 14: Nuestra aplicación no es muy accesible, hagamos que podamos agregar, borrar y editar regalos sin tocar el mouse.
        </h1>
      </section>
    </>
  );
